      ...
      {/* <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8 p-4 sm:p-6 bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen"> */}
        <div className="bg-zinc-800  rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-4 sm:p-8 border border-gray-100 transform transition-all hover:scale-[1.01]">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-8 mb-6 sm:mb-8 animate-fade-in">
            <h1 className="text-2xl text-gray-200 sm:text-4xl font-bold text-transparent">
             Your Profile
            </h1>
            <div className="flex flex-col sm:flex-row gap-2 sm:space-x-2 w-full sm:w-auto">
            <Button 
                onClick={() => setPreviewProfile(true)}
                className="w-full sm:w-auto bg-gradient-to-r from-pink-600 to-purple-700 hover:from-indigo-700 hover:to-purple-800 transition-all text-white"
              >
                Preview My Profile
              </Button>
              <Button 
                onClick={handleSave} 
                disabled={saving}
                className="w-full sm:w-auto bg-gradient-to-r from-pink-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transition-all text-white"
              >
              ...
              <Button 
                variant="outline" 
                onClick={() => navigate(-1)}
                className="w-full text-gray-300 sm:w-auto hover:bg-gray-500  transition-colors group"
              >
                <X className="mr-2 h-4 w-4 text-gray-300 group-hover:rotate-180 transition-transform" /> Cancel
              </Button>
          ...
          <section className="mb-8 sm:mb-12">
            ...
            >
              <h2 className="text-lg sm:text-xl font-semibold text-gray-300 mb-4 border-b pb-2">
                Basic Information
              </h2>
            ...
            {expandedSections.basicInfo && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 animate-slide-down">
                <div className="relative group">
                  <label className="block text-sm font-medium text-gray-300 mb-3">Display Name</label>
                  <input
                    type="text"
                    className="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm sm:text-base py-2"
          ...
          <section className="mb-8 sm:mb-12">
            ...
            >
              <h2 className="text-lg sm:text-xl font-semibold text-gray-300 mb-4 border-b pb-2 flex items-center">
          ...
          <section className="mb-8 sm:mb-12">
            ...
            >
              <h2 className="text-lg sm:text-xl font-semibold text-gray-200 mb-4 border-b pb-2">
                Social Links
              </h2>
            ...
            {expandedSections.socialLinks && (
              <div className="grid md:grid-cols-2 gap-6 animate-slide-down">
                <div>
                  ...
                  <input
                    type="url"
                    className="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500 py-2"
...
//                           "py-2 px-4 rounded-lg transition-all text-xs sm:text-sm flex items-center justify-center space-x-2 group",
//                           profile.experience === level 
//                             ? "bg-gradient-to-r from-pink-500 to-purple-500 text-white shadow-lg hover:shadow-xl transition-all group" 
//                             : "bg-gray-100 text-gray-600 hover:bg-gray-200"
//                         )}
//                       >
//                         {level.charAt(0).toUpperCase() + level.slice(1)}
